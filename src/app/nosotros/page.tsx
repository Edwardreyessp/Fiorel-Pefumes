				...
				<Stack spacing={1}>
					...
					>
						...
						>
							...
							<Typography>
								...
								Phasellus vitae convallis neque. Phasellus pellentesque risus
								sit amet gravida dictum. Donec iaculis eros eu neque efficitur,
								ac consectetur felis suscipit. Suspendisse et congue ante. Cras
								vel convallis leo. Etiam mattis iaculis nisl mattis semper
							</Typography>
						</Box>
					</Box>
					<Box
					...
					>
						...
						>
							...
							<Box pt={3}>
								<Stats
									startIcon={<IconPerfume />}
									text={'Perfumes vendidos'}
									valueShown={'+50'}
								/>
							</Box>
							<Box pt={3}>
