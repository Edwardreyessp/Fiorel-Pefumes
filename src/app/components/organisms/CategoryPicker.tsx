...
import { CategoryContext, type TagData } from '@/app/admin/categorias/Provider';

async function saveTag(tag: TagData): Promise<void> {
...
async function deleteTag(tag: TagData): Promise<void> {
	await fetch(`${process.env.NEXT_PUBLIC_API_URL}/categories`, {
		method: 'DELETE',
		headers: {
			'Content-Type': 'application/json',
